...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if (c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), m = parseFloat(c[3]), p = parseFloat(c[4]), n = parseFloat(c[5]), c = parseFloat(c[6]), q = f.left + f.width, r = f.top + f.height, t = f.left * d, d = q * d, u = f.left * e, e = q * e, v = f.top * m, m = r * m, w = f.top * p, q = r * p, r = t + v + n, p = u + w + c, v = d + v + n, w = e + w + c, t = t + m + n, u = u + q + c, n = d + m + n, c = e + q + c;
